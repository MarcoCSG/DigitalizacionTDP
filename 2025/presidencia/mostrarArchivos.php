...
<body>
    ...
    <section>
        <figure>
            <img class="imgMisantla" src="../../img/misantla.png" alt="">
        </figure>
        <figure>
            <img class="imgEmpresa" src="../../img/logoEmpresa.png" alt="">
        </figure>
        <!-- Agrega un botón/enlace para regresar al home -->
    <!-- <div>
        <a  class="regresar-home" href="cl_presidencia.php">REGRESAR A MENÚ<br>presidencia</a>
    </div> -->
    </section>
    ...
    if (isset($_GET['subclasificacion']) && isset($_GET['clasificacion']) && isset($_GET['area'])) {
        ...
        $consultaTotal = "SELECT SUM(cantidad_folios) AS total_folios FROM presidencia WHERE subclasificacion = '$subclasificacion' AND clasificacion = '$clasificacion' AND area = '$area'";
        ...
        $consulta = "SELECT * FROM presidencia WHERE subclasificacion = '$subclasificacion' AND clasificacion = '$clasificacion' AND area = '$area' LIMIT $offset, $filasPorPagina";
        ...
        <table>
            ...
            <tbody>
                ...
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    ?>
                    <tr>
                        <td><img src="../../img/pdf.png" alt="Icono PDF" class="icon"><?php echo $fila['nombre_archivo']; ?></td>
        ...
        <div class="paginacion">
            ...
            $totalFilas = mysqli_num_rows(mysqli_query($conexion, "SELECT * FROM presidencia WHERE subclasificacion = '$subclasificacion' AND clasificacion = '$clasificacion' AND area = '$area'"));
