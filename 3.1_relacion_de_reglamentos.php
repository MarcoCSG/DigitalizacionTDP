...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="php/subirFormato3_1.php" onsubmit="convertirAMayusculas()">
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">El nombre del Reglamento de que se trate. Ejemplo: Reglamento Interior del Ayuntamiento de…, Reglamento de Servicios del
                                        Ayuntamiento</span>
                </div>
                </label>
                <input type="text" id="denominacion" name="denominacion" placeholder="Ingrese la denominación" spellcheck="true" > 
            </div>
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">La referencia numérica del acta de la sesión de cabildo en la que se haya aprobado el reglamento municipal referido, así como el
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">La referencia numérica de la Gaceta Oficial en que se publicó el reglamento municipal referido, así como, el día, mes y año de la
                    misma.</span>
                </div>
                </label>
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">Los comentarios que se consideren importantes respecto a los reglamentos municipales referidos.</span>
                </div>
                </label>
                <input type="text" id="observaciones_3_1" name="observaciones_3_1" placeholder="Ingrese observaciones" spellcheck="true" > 
            </div>
