...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="php/subirFormato3_4.php" onsubmit="convertirAMayusculas()">
            ...
            <div class="form-group">
                <label for="ejercicio">EJERCICIO
                    <div class="tooltip-container">
                        <button type="button" class="help-button">?</button>
                        <span class="tooltip">El año al que corresponde el Acta. Se recomienda que las Actas se relacionen por año iniciando con 2018, posteriormente 2019,
                        2020 y finalmente 2021.</span>
                    </div>
                </label>
                <input type="number" id="ejercicio" name="ejercicio" placeholder="Ingrese el ejercicio" spellcheck="true">
            </div>
