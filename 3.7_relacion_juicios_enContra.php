...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="php/subirFormato3_7.php" onsubmit="convertirAMayusculas()">
            ...
            <div class="form-group">
                <label for="fecha">FECHA
                    <div class="tooltip-container">
                        <button type="button" class="help-button">?</button>
                        <span class="tooltip">El día, mes y año de inicio del proceso jurídico.</span>
                    </div>
                </label>
            ...
            <div class="form-group">
                <label for="promovido_ante">PROMOVIDO ANTE
                    <div class="tooltip-container">
                        <button type="button" class="help-button">?</button>
                        <span class="tooltip">El juzgado o tribunal encargado del análisis y resolución del proceso jurídico.</span>
                    </div>
                </label>
            ...
            <div class="form-group">
                ...
                <input type="text" id="demandante" name="demandante" placeholder="Ingrese eL demandante" spellcheck="true">
            </div>
            ...
            <div class="form-group">
                <label for="descripcion">DESCRIPCIÓN
                    <div class="tooltip-container">
                        <button type="button" class="help-button">?</button>
                        <span class="tooltip">El motivo por el cual se inició el proceso jurídico.</span>
                    </div>
                </label>
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">El importe monetario que pueda generarse con el fallo en contra del Ayuntamiento.</span>
                </div>
