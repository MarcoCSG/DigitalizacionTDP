...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="php/subirFormato5_11.php">
            ...
            <div class="form-group">
                ...
                <textarea id="nombre_expediente" name="nombre_expediente" placeholder="Ingrese el nombre del expediente"></textarea> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="serie_documental" name="serie_documental" placeholder="Ingrese la serie documental"> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="descripcion_contenido" name="descripcion_contenido" placeholder="Ingrese la descripción del contenido"></textarea> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="vigencia_documental" name="vigencia_documental" placeholder="Ingrese la vigencia documental"> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="area_responsable" name="area_responsable" placeholder="Ingrese el área responsable"> <!-- Agregado name -->
            </div>
            ...
            <button type="submit" name="guardar">GUARDAR</button> <!-- Cambiado para ser un botón de tipo submit -->
            </div>
