...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="php/subirFormato5_12.php" onsubmit="convertirAMayusculas()">
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">El nombre del área responsable de la generación del archivo relacionado.</span>
                </div>
                <input type="text" id="unidad_administrativa" name="unidad_administrativa" placeholder="Ingrese la unidad administrativa" spellcheck="true" > <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <div class="tooltip-container">
                    <button type="button" class="help-button">?</button>
                    <span class="tooltip">El periodo durante el cual un documento deberá permanecer como archivo de concentración. </span>
                </div>
                <input type="text" id="vigencia_documental" name="vigencia_documental" placeholder="Ingrese su vigencia documental" spellcheck="true" > <!-- Agregado name -->
            </div>
