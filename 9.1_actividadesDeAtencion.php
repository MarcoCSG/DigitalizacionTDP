...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="php/subirFormato9_1.php">
            ...
            <div class="form-group">
                ...
                <input type="text" id="actividad" name="actividad" placeholder="Ingrese la actividad"> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" id="fecha" name="fecha" placeholder="Ingrese la serie documental"> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="observaciones" name="observaciones" placeholder="Ingrese la cantidad"></textarea> <!-- Agregado name -->
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="area_responsable" name="area_responsable" placeholder="Ingrese nombre de la persona"> <!-- Agregado name -->
            </div>
