...
<body>
    ...
    <div class="search-container">
        <form method="get" action="mostrarArchivos5_18.php"> <!-- Cambiar a un archivo específico para 5_11 si es necesario -->
    ...
    function generarPDF() {
        ...
        const url = `php/generarPDF5_18.php?search=${encodeURIComponent(search)}&anio=${encodeURIComponent(anio)}&area=${encodeURIComponent(area)}&clasificacion=${encodeURIComponent(clasificacion)}&elaboro=${encodeURIComponent(elaboro)}&autorizo=${encodeURIComponent(autorizo)}`;
