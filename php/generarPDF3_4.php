...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $title = '3.4 Relación de Actas del Consejo de Planeación para el Desarrollo Municipal (COPLADEMUN)';
        ...
        $this->Cell($ancho_columnas['Ejercicio'], 20, iconv('UTF-8', 'ISO-8859-1', 'EJERCICIO'), 1, 0, 'C', true);
...
function obtenerDatos($conexion, $municipio, $anio, $area_nombre, $clasificacion_codigo, $search)
{
    ...
    $query = "SELECT f.id, f.municipio, f.anio, f.ruta_archivo, 
                    f34.no, f34.numero, f34.fecha, f34.asunto, 
                    f34.ejercicio, f34.fojas, f34.firma_si, f34.firma_no, f34.sello_si,
                    f34.sello_no, f34.informacion_al, f34.responsable
                FROM formatos f
...
{
    global $ancho_no, $ancho_numero, $ancho_fecha, $ancho_asunto, $ancho_ejercicio, $ancho_fojas, $ancho_firma_si, $ancho_firma_no, $ancho_sello_no, $ancho_sello_si;
    ...
    PrintCenteredCell($pdf, $ancho_ejercicio, $altura_maxima, $row['ejercicio']);
