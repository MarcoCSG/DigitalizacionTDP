...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $title = '3.6 Relación de Juicios en Proceso Promovidos por el Ayuntamiento';
...
function obtenerDatos($conexion, $municipio, $anio, $area_nombre, $clasificacion_codigo, $search)
{
    ...
    $query = "SELECT f.id, f.municipio, f.anio, f.ruta_archivo, 
                    f36.no, f36.tipo, f36.fecha, f36.promovido_ante, 
                    f36.en_contra_de, f36.descripcion, f36.estado_juridico, 
                    f36.acciones_inmediatas, f36.informacion_al, f36.responsable
                FROM formatos f
    ...
    if (!empty($search)) {
        $query .= " AND (f36.tipo LIKE ? OR f36.responsable LIKE ?)";
        $search_param = "%" . $search . "%";
        $params[] = $search_param;
        $params[] = $search_param;
...
$ancho_en_contra_de = 40;
$ancho_descripcion = 47;
$ancho_estado_juridico = 50;
$ancho_acciones_inmediatas = 35;
...
{
    global $ancho_no, $ancho_tipo, $ancho_fecha, $ancho_promovido_ante, $ancho_en_contra_de, $ancho_descripcion, $ancho_estado_juridico, $ancho_acciones_inmediatas;
    ...
    PrintCenteredCell($pdf, $ancho_en_contra_de, $altura_maxima, $row['en_contra_de']);
