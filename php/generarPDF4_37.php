...
foreach ($datos as $row) {
    ...
    $pdf->Cell($pdf->ancho_columnas['BANCO'], 10, iconv('UTF-8', 'ISO-8859-1', $row['banco']), 1, 0, 'C');
    $pdf->Cell($pdf->ancho_columnas['NUMERO DE CUENTA'], 10, iconv('UTF-8', 'ISO-8859-1', $row['no_cuenta']), 1, 0, 'C');
    $pdf->Cell($pdf->ancho_columnas['TOTAL'], 10, iconv('UTF-8', 'ISO-8859-1', $row['total']), 1, 0, 'C');
    $pdf->Cell($pdf->ancho_columnas['UTILIZADOS'], 10, iconv('UTF-8', 'ISO-8859-1', $row['utilizados']), 1, 0, 'C');
    $pdf->Cell($pdf->ancho_columnas['POR UTILIZAR'], 10, iconv('UTF-8', 'ISO-8859-1', $row['por_utilizar']), 1, 0, 'C');
    $pdf->Cell($pdf->ancho_columnas['CANCELADOS'], 10, iconv('UTF-8', 'ISO-8859-1', $row['cancelados']), 1, 0, 'C');
